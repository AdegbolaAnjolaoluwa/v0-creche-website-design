...
import { Users, BookOpen, FileText, CheckCircle, File, Activity, Calendar } from "lucide-react"
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{metrics.totalPublishedResults}</div>
          <p className="text-xs text-muted-foreground">
            {metrics.totalDraftResults} drafts pending
          </p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{metrics.todaysAttendance}</div>
        </CardContent>
      </Card>
    </div>
  )
